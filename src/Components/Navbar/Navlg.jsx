...
const Navlg = () => {
  return (
    <nav className="relative">
      <div className="nav-container w-full h-auto hidden lg:block xl:block 2xl:block bg-white shadow-sm px-4 md:px-6 lg:px-10 py-3 fixed top-0 left-0 right-0 z-50">
